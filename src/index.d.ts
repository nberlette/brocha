...
export function compile(
  input: string,
  options?: CompileOptions & { async: true },
): <T extends Args>(data?: T, blocks?: Blocks) => Promise<string>
export function compile(
  input: string,
  options?: CompileOptions & { async?: false },
): <T extends Args>(data?: T, blocks?: Blocks) => string
